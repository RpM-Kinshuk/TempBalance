...
step_size = 10
sampling_ops = 10
qr_list = [0.25, 0.5, 1.0, 1.5, 2.0]
ops_list = [2, 4, 10, 20, 30]
...
for q_ratio, sampling_ops in grid:
    ...
    save_path = f"/jumbo/yaoqingyang/kinshuk/TempBalance/results/newest/{model}{depth}/{dataset}/slide_{slide_window}"
